...
/* #define FONT			"-ttf-bankgothicattltbt-medium-r-normal-*-10-*-*-*-p-*-iso8859-1" */
/* #define FONT			"-microsoft-verdana-medium-r-normal-*-*-90-*-*-p-*-microsoft-cp1251" */
/* #define FONT			"-ttf-verdana-medium-r-normal-*-9-*-*-*-p-*-iso8859-1" */
/* #define FONT			"-*-fixed-medium-r-normal-*-10-*-*-*-*-*-*-*" */
#define FONT			"-*-lucida-medium-r-normal-*-10-*-*-*-*-*-*-*"
/* #define FONT			"-*-helvetica-medium-r-*-*-*-80-*-*-*-*-*-*" */
...
/* 	{ MODKEY,			XK_r,		spawn,		"exec `cat /home/pmv/app-data/dwm/PROGS | dmenu -b -p 'exec'`" }, \ */ \
	{ MODKEY,			XK_r,		spawn,		"exec `cat /home/pmv/app-data/dwm/PROGS | dmenu`" }, \
/* 	{ MODKEY,			XK_o,		spawn,		"exec mpc play `mpc playlist --format %file% | colrm 60 500 | dmenu -fn '-microsoft-verdana-medium-r-normal-*-*-90-*-*-p-*-microsoft-cp1251' -b -p '>' | colrm 1 1 | cut -d')' -f1`" }, \ */ \
